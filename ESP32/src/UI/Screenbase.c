...
void BaseScreenSetup(lv_obj_t * basescreen, lv_event_cb_t event_cb_more)
{
  ...
  lv_obj_set_style_bg_color(obj,lv_palette_darken(LV_PALETTE_BLUE,2), LV_PART_MAIN);      

  obj = lv_label_create(obj);
  lv_obj_align(obj, LV_ALIGN_CENTER, 0, 0);
  lv_label_set_text(obj, "Wind Chime");

  // Control Panel button (center-left)
  obj = lv_btn_create(nav);
  lv_obj_align(obj, LV_ALIGN_LEFT_MID, lv_pct(25), 0);
  lv_obj_set_size(obj, lv_pct(22), LV_SIZE_CONTENT);
  lv_obj_add_event_cb(obj, event_cb_more, LV_EVENT_CLICKED, (void *)2);      
  lv_obj_set_style_bg_color(obj,lv_palette_darken(LV_PALETTE_GREEN,2), LV_PART_MAIN);      

  obj = lv_label_create(obj);
  lv_obj_align(obj, LV_ALIGN_CENTER, 0, 0);
  lv_label_set_text(obj, "Control");

  // More button (center-right)
  obj = lv_btn_create(nav);
  lv_obj_align(obj, LV_ALIGN_RIGHT_MID, -lv_pct(25), 0);
  lv_obj_set_size(obj, lv_pct(22), LV_SIZE_CONTENT);
  lv_obj_add_event_cb(obj, event_cb_more, LV_EVENT_CLICKED, (void *)3);      
  ...
  lv_obj_set_style_bg_color(obj,lv_palette_darken(LV_PALETTE_RED,2), LV_PART_MAIN);      
  ...
  lv_obj_align(basescreeninfo, LV_ALIGN_CENTER, 0, -30);
  lv_obj_set_style_text_font(basescreeninfo, &lv_font_montserrat_18, LV_PART_MAIN| LV_STATE_DEFAULT);  
  lv_label_set_text(basescreeninfo, "Sensor Data");
